...
export default function ViewerStandalone() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-black">
      ...
      <div
        id="cesiumContainer"
        className="absolute top-16 left-0 right-0 bottom-0 bg-black"
      />
  
      {loading && (
        <div
          id="loadingOverlay"
          className="absolute inset-0 z-10 flex items-center justify-center bg-white/85 text-lg font-semibold"
        >
          <div id="loadingMessage">Loading Tileset...</div>
        </div>
      )}
    </div>
  );
